...
- Создайте администратора командой `python3 manage.py createsuperuser`
...
Админка доступка по адресу `/admin`. Для входа используетй учетку созданную на этапе запуска.